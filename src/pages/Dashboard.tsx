...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* Hero Section */}
      <section className="relative responsive-hero responsive-padding overflow-hidden">
        {/* Background Image */}
        <div 
      ...
      {/* Footer */}
      <footer className="relative bg-gradient-to-br from-background via-background/95 to-card/50 border-t border-border/50 py-12 md:py-16 px-4 md:px-6 overflow-hidden">
        {/* Background Pattern */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold gradient-text">{CONTACT_INFO.name}</h3>
              </div>
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-4">
                <a
                  ...
                  className="group p-3 rounded-full bg-gradient-to-br from-pink-500/10 to-purple-500/10 hover:from-pink-500/20 hover:to-purple-500/20 transition-all duration-300 hover:scale-110"
                  aria-label="Instagram"
                >
                  <svg className="h-5 w-5 text-pink-500 group-hover:text-pink-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-3 rounded-full bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 transition-all duration-300 hover:scale-110"
                  aria-label="Facebook"
                >
                  <svg className="h-5 w-5 text-blue-600 group-hover:text-blue-500 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-3 rounded-full bg-gradient-to-br from-blue-700/10 to-blue-800/10 hover:from-blue-700/20 hover:to-blue-800/20 transition-all duration-300 hover:scale-110"
                  aria-label="LinkedIn"
                >
                  <svg className="h-5 w-5 text-blue-700 group-hover:text-blue-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-3 rounded-full bg-gradient-to-br from-gray-500/10 to-gray-600/10 hover:from-gray-500/20 hover:to-gray-600/20 transition-all duration-300 hover:scale-110"
                  aria-label="GitHub"
                >
                  <svg className="h-5 w-5 text-gray-600 group-hover:text-gray-500 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
