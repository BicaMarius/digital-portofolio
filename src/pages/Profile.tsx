              ...
              <Card className={`${isMobile ? 'p-4' : 'p-8'} hover-lift`}>
                  ...
                  <div className={`flex items-center gap-3 ${isMobile ? 'justify-center' : ''}`}>
                    {cvData && (
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            const response = await fetch(cvData.fileUrl);
                            const blob = await response.blob();
                            const url = window.URL.createObjectURL(blob);
                            const link = document.createElement('a');
                            link.href = url;
                            link.download = cvData.fileName.endsWith('.pdf') ? cvData.fileName : `${cvData.fileName}.pdf`;
                ...
                {pendingPreviewUrl || cvData ? (
                  <div className="bg-muted/30 rounded-lg overflow-hidden">
                    ...
                    <div style={{ minHeight: 'clamp(480px, 62vh, 860px)' }}>
                ...
                <div className={`${isMobile ? 'space-y-6' : 'responsive-contact'}`}>
                  ...
                  <Card className="hover-lift">
                    <CardContent className={`${isMobile ? 'p-4' : 'p-6'}`}>
                      ...
                      <div className="mt-6">
                        <h4 className={`font-medium mb-4 ${isMobile ? 'text-sm text-center' : ''}`}>Social Media & Links</h4>
                        <div className={`grid gap-3 ${isMobile ? 'grid-cols-1' : 'grid-cols-2'}`}>
                          <a
                            href={CONTACT_INFO.socialMedia.instagram}
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`flex items-center justify-center gap-3 p-3 rounded-lg bg-gradient-to-br from-pink-500/10 to-purple-500/10 hover:from-pink-500/20 hover:to-purple-500/20 transition-all duration-300`}
                          >
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`flex items-center justify-center gap-3 p-3 rounded-lg bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 transition-all duration-300`}
                          >
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`flex items-center justify-center gap-3 p-3 rounded-lg bg-gradient-to-br from-blue-700/10 to-blue-800/10 hover:from-blue-700/20 hover:to-blue-800/20 transition-all duration-300`}
                          >
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`flex items-center justify-center gap-3 p-3 rounded-lg bg-gradient-to-br from-gray-500/10 to-gray-600/10 hover:from-gray-500/20 hover:to-gray-600/20 transition-all duration-300`}
                          >
